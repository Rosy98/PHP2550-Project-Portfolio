...
# save the data
# save(framingham_df, file = "framingham_df.RData")
...
# save the data
# save(df_2017, file = "df_2017.RData")
...
t1 <- xtabs(~ CURSMOKE + DIABETES + BPMEDS, data=framingham_df) 
ftable(t1)

cor(framingham_df_men[, -2])
cor(framingham_df_women[, -2])
